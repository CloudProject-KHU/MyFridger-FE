...
export const INGREDIENT_ICON_CATEGORIES: IngredientIconCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // 추가 조미료
      { id: 'honey', name: '꿀' },
      { id: 'anchovy_sauce', name: '까나리액젓' },
      { id: 'coarse_salt', name: '굵은소금' },
      { id: 'ground_sesame', name: '깨소금' },
      { id: 'teriyaki_sauce', name: '데리야끼소스' },
      { id: 'tonkatsu_sauce', name: '돈까스소스' },
      { id: 'anchovy_fish_sauce', name: '멸치액젓' },
      { id: 'corn_syrup', name: '물엿' },
      { id: 'msg', name: '미원' },
      { id: 'dashida', name: '다시다' },
      { id: 'ssamjang', name: '쌈장' },
      { id: 'oligodang', name: '올리고당' },
      { id: 'olive_oil', name: '올리브유' },
      { id: 'jajang_powder', name: '짜강가루' },
      { id: 'cheonggukjang', name: '청국장' },
      { id: 'chogochujang', name: '초고추장' },
      { id: 'chunjang', name: '춘장' },
      { id: 'chili_sauce', name: '칠리소스' },
      { id: 'hot_sauce', name: '핫소스' },
    ],
  },
  {
    value: 'etc',
